...
#include <messenger.h>
    ...
    use mod_chidg_edit_adjoint,             only: chidg_edit_adjoint
...
contains
    ...
    subroutine chidg_edit(filename)
        ...
        do while ( run )
            ...
            call write_line("1: domain info","2: boundary conditions","3: mesh motion","4: adjoint","0: exit", columns=.True., column_width=22, color='blue')
