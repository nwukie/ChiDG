...
contains
    ...
    !!
    !-----------------------------------------------------------------------------------
    subroutine set_coupled_element_data(self,face_ID,idomain_g,ielement_g,nfields,ntime,nterms_s,nnodes_r,dof_start,dof_local_start,total_area,areas,quad_pts)
        class(bc_patch_t),  intent(inout)   :: self
        integer(ik),        intent(in)      :: face_ID
        integer(ik),        intent(in)      :: idomain_g
        integer(ik),        intent(in)      :: ielement_g
        ...
        call self%coupling(face_ID)%set_coupled_element_data(idomain_g,ielement_g,nfields,ntime,nterms_s,nnodes_r,dof_start,dof_local_start,total_area,areas,point_t(quad_pts))
