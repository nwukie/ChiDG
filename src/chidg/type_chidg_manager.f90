...
contains
    ...
    subroutine process(self,chidg)
        ...
        integer(ik)                 :: ifield
        type(svector_t)             :: auxiliary_fields
        ...
        !
        auxiliary_fields = chidg%data%get_auxiliary_field_names()
        do ifield = 1,auxiliary_fields%size()

            field_name = auxiliary_fields%at(ifield)
