module BU_volume_advective_flux
#include <messenger.h>
    ...
    !
    !----------------------------------------------------------------
    type, extends(volume_flux_t), public :: BU_volume_advective_flux_t


    contains
        procedure   :: compute

    end type BU_volume_advective_flux_t
...
contains
    ...
    subroutine compute(self,mesh,sdata,prop,idom,ielem,iblk)
        class(BU_volume_advective_flux_t),  intent(in)      :: self
        ...
        !
        flux_x = HALF * cx  *  u**TWO
        flux_y = HALF * cy  *  u**TWO
        flux_z = HALF * cz  *  u**TWO
...
end module BU_volume_advective_flux
