...
contains
    ...
    subroutine compute(self,mesh,sdata,prop,idom,ielem,iblk)
        ...
        call integrate_volume_source(mesh(idom)%elems(ielem),sdata,idom,irho_i,iblk,flux_x)
        ...
        call integrate_volume_source(mesh(idom)%elems(ielem),sdata,idom,irhou_i,iblk,flux_x)
        ...
        call integrate_volume_source(mesh(idom)%elems(ielem),sdata,idom,irhov_i,iblk,flux_x)
...
!
        ...
        call integrate_volume_source(mesh(idom)%elems(ielem),sdata,idom,irhoE_i,iblk,flux_x)
