module PRIMLINEULERAXI_LaxFriedrichs_flux_imag
    ...
    !!
    !-------------------------------------------------------------------------------------------
    type, extends(boundary_flux_t), public :: PRIMLINEULERAXI_LaxFriedrichs_flux_imag_t

    contains

        procedure  :: compute

    end type PRIMLINEULERAXI_LaxFriedrichs_flux_imag_t
    !********************************************************************************************
...
contains
    ...
    subroutine compute(self,mesh,sdata,prop,face_info,function_info)
        class(PRIMLINEULERAXI_LaxFriedrichs_flux_imag_t),  intent(in)      :: self
...
end module PRIMLINEULERAXI_LaxFriedrichs_flux_imag
