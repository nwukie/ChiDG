module PRIMLINEULERAXI_volume_advective_sourceterms_real
    ...
    !!
    !----------------------------------------------------------------------------------------
    type, extends(volume_flux_t), public :: PRIMLINEULERAXI_volume_advective_sourceterms_real_t
    ...
    end type PRIMLINEULERAXI_volume_advective_sourceterms_real_t
    !*****************************************************************************************
...
contains
    ...
    subroutine compute(self,mesh,sdata,prop,idom,ielem,iblk)
        class(PRIMLINEULERAXI_volume_advective_sourceterms_real_t),    intent(in)      :: self
...
end module PRIMLINEULERAXI_volume_advective_sourceterms_real
