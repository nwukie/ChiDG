module bc_primlineuleraxi_axi
    ...
    !!
    !-------------------------------------------------------------------------------------------
    type, public, extends(bc_t) :: primlineuleraxi_axi_t
    ...
    end type primlineuleraxi_axi_t
    !*******************************************************************************************
...
contains
    ...
    subroutine add_options(self)
        class(primlineuleraxi_axi_t),    intent(inout)   :: self

        !
        ! Set name
        ! 
        call self%set_name('primlineuleraxi_axi')
...
end module bc_primlineuleraxi_axi
