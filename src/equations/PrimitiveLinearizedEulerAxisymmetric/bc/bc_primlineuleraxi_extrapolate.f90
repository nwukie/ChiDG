module bc_primlineuleraxi_extrapolate
    ...
    !!
    !-------------------------------------------------------------------------------------------
    type, public, extends(bc_t) :: primlineuleraxi_extrapolate_t
    ...
    end type primlineuleraxi_extrapolate_t
    !*******************************************************************************************
...
contains
    ...
    subroutine add_options(self)
        class(primlineuleraxi_extrapolate_t),    intent(inout)   :: self

        !
        ! Set name
        ! 
        call self%set_name('primlineuleraxi_extrapolate')
...
end module bc_primlineuleraxi_extrapolate
