module bc_primlineuleraxi_outlet
    ...
    !!
    !-------------------------------------------------------------------------------------------
    type, public, extends(bc_t) :: primlineuleraxi_outlet_t
    ...
    end type primlineuleraxi_outlet_t
    !*******************************************************************************************
...
contains
    ...
    subroutine add_options(self)
        class(primlineuleraxi_outlet_t),    intent(inout)   :: self

        !
        ! Set name
        ! 
        call self%set_name('primlineuleraxi_outlet')
...
end module bc_primlineuleraxi_outlet
