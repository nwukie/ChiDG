module PRIMLINEULERAXI_volume_advective_flux_real
    ...
    !!
    !----------------------------------------------------------------------------------
    type, extends(volume_flux_t), public :: PRIMLINEULERAXI_volume_advective_flux_real_t
    ...
    end type PRIMLINEULERAXI_volume_advective_flux_real_t
    !***********************************************************************************
...
contains
    ...
    subroutine compute(self,mesh,sdata,prop,idom,ielem,iblk)
        class(PRIMLINEULERAXI_volume_advective_flux_real_t),   intent(in)      :: self
...
end module PRIMLINEULERAXI_volume_advective_flux_real
