...
!        flux_z_p = -diffusion_z_p * deps_dz_p
        flux_x_m = -0.05_rk*deps_dx_m
        flux_y_m = -0.05_rk*deps_dy_m
        flux_z_m = -0.05_rk*deps_dz_m

        flux_x_p = -0.05_rk*deps_dx_p
        flux_y_p = -0.05_rk*deps_dy_p
        flux_z_p = -0.05_rk*deps_dz_p
