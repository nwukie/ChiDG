module bc_state_artificial_viscosity_inlet
#include <messenger.h>
    ...
    !!
    !-------------------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: artificial_viscosity_inlet_t
    ...
    end type artificial_viscosity_inlet_t
    !*******************************************************************************************
...
contains
    ...
    subroutine init(self)
        class(artificial_viscosity_inlet_t),   intent(inout) :: self
        

        !
        ! Set name, family
        !
        call self%set_name('Artificial Viscosity Inlet')
...
end module bc_state_artificial_viscosity_inlet
