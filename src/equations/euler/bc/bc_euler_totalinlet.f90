...
#include <messenger.h>
    ...
    !!
    !-------------------------------------------------------------------------------------------
    type, public, extends(bc_operator_t) :: euler_totalinlet_t
...
!        !
!        worker%store_bc_state(irho, rho_bc,  'value')
!        worker%store_bc_state(irhou,rhou_bc, 'value')
!        worker%store_bc_state(irhov,rhov_bc, 'value')
!        worker%store_bc_state(irhow,rhow_bc, 'value')
!        worker%store_bc_state(irhoE,rhoE_bc, 'value')
