...
contains
    ...
    subroutine compute(self,worker,prop)
        ...
        ! Compute gamma
        !
        call prop%fluid%compute_gamma(rho_bc,rhou_bc,rhov_bc,rhow_bc,rhoE_bc,gam_bc)
        call prop%fluid%compute_pressure(rho_bc,rhou_bc,rhov_bc,rhow_bc,rhoE_bc,p_bc)
