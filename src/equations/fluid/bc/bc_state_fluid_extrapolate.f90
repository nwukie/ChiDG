...
!        call self%set_equation("Energy"    )
    ...
    subroutine compute_bc_state(self,worker,prop)
        ...
        !
        call worker%store_bc_state("Density"   ,irho,  rho_m, 'value')
        call worker%store_bc_state("X-Momentum",irhou, rhou_m,'value')
        call worker%store_bc_state("Y-Momentum",irhov, rhov_m,'value')
        call worker%store_bc_state("Z-Momentum",irhow, rhow_m,'value')
        call worker%store_bc_state("Energy"    ,irhoE, rhoE_m,'value')
