module bc_state_rotating_wall
    ...
    !!
    !-------------------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: rotating_wall_t
...
contains
    ...
    subroutine init(self)
        class(rotating_wall_t),   intent(inout) :: self
...
end module bc_state_rotating_wall
