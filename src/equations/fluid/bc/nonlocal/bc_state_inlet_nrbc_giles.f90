module bc_state_inlet_nrbc_giles
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------
    type, public, extends(nonlocal_nrbc_giles_base_t) :: inlet_nrbc_giles_t
...
contains
    ...
    subroutine init(self)
        class(inlet_nrbc_giles_t),   intent(inout) :: self

        ! Set name, family
        call self%set_name('Inlet - Nonlocal NRBC Giles')
...
end module bc_state_inlet_nrbc_giles
