module bc_state_inlet_nrbc_lindblad_form3_fix
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------
    type, public, extends(nonlocal_nrbc_lindblad_base_fix_t) :: inlet_nrbc_lindblad_form3_fix_t
    ...
    end type inlet_nrbc_lindblad_form3_fix_t
    !*********************************************************************************
...
contains
    ...
    subroutine init(self)
        class(inlet_nrbc_lindblad_form3_fix_t),   intent(inout) :: self

        ! Set name, family
        call self%set_name('Inlet - Nonlocal NRBC Lindblad Form3 Fix')
...
end module bc_state_inlet_nrbc_lindblad_form3_fix
