module bc_state_outlet_nrbc_lindblad
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------
    type, public, extends(nonlocal_nrbc_lindblad_base_t) :: outlet_nrbc_lindblad_t
    ...
    end type outlet_nrbc_lindblad_t
    !*********************************************************************************
...
contains
    ...
    subroutine init(self)
        class(outlet_nrbc_lindblad_t),   intent(inout) :: self

        ! Set name, family
        call self%set_name('Outlet - Nonlocal NRBC Lindblad')
...
end module bc_state_outlet_nrbc_lindblad
