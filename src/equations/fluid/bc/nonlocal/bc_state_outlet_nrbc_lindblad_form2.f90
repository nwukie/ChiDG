module bc_state_outlet_nrbc_lindblad_form2
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------
    type, public, extends(nonlocal_nrbc_lindblad_base_t) :: outlet_nrbc_lindblad_form2_t
    ...
    end type outlet_nrbc_lindblad_form2_t
    !*********************************************************************************
...
contains
    ...
    subroutine init(self)
        class(outlet_nrbc_lindblad_form2_t),   intent(inout) :: self

        ! Set name, family
        call self%set_name('Outlet - Nonlocal NRBC Lindblad Form2')
    ...
    subroutine compute_bc_state(self,worker,prop,bc_comm)
        ...
        type(AD_D)  :: density_avg, vel1_avg, vel2_avg, vel3_avg, pressure_avg, c_avg, c5_1d, ddensity_avg, dvel3_avg, dpressure_avg
        ...
        density_bc  = density_m  - density_reflect
        vel1_bc     = vel1_m     - vel1_reflect
        vel2_bc     = vel2_m     - vel2_reflect
        vel3_bc     = vel3_m     - vel3_reflect
        pressure_bc = pressure_m - pressure_reflect
        ...
        c5_1d = ZERO*pressure_avg
        c5_1d = -TWO*(pressure_avg - p_user(1))

        ! Perturbation to global average 
        ddensity_avg  = (ONE/(TWO*c_avg*c_avg))*c5_1d
        dvel3_avg     = -(ONE/(TWO*density_avg*c_avg))*c5_1d
        dpressure_avg = HALF*c5_1d
...
!        end do !iradius
    ...
    subroutine compute_interior_reflection(self,worker,bc_comm,                    &
        ...
        a2_real = ZERO*a2_real_m
        a3_real = ZERO*a3_real_m
        a4_real = ZERO*a4_real_m

        a1_imag = ZERO*a1_imag_m
        a2_imag = ZERO*a2_imag_m
        a3_imag = ZERO*a3_imag_m
...
end module bc_state_outlet_nrbc_lindblad_form2
