module bc_state_outlet_nrbc_lindblad_form3
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------
    type, public, extends(nonlocal_nrbc_lindblad_base_t) :: outlet_nrbc_lindblad_form3_t
    ...
    end type outlet_nrbc_lindblad_form3_t
    !*********************************************************************************
...
contains
    ...
    subroutine init(self)
        class(outlet_nrbc_lindblad_form3_t),   intent(inout) :: self

        ! Set name, family
        call self%set_name('Outlet - Nonlocal NRBC Lindblad Form3')
...
end module bc_state_outlet_nrbc_lindblad_form3
