module bc_state_turbo_interface_steady_form3
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------
    !type, public, extends(giles_HB_base_t) :: turbo_interface_steady_form3_t
    type, public, extends(nonlocal_nrbc_lindblad_base_t) :: turbo_interface_steady_form3_t
    ...
    end type turbo_interface_steady_form3_t
    !*********************************************************************************
...
contains
    ...
    subroutine init(self)
        class(turbo_interface_steady_form3_t),   intent(inout) :: self

        ! Set name, family
        call self%set_name('Steady Turbo Interface Form3')
    ...
    subroutine compute_bc_state(self,worker,prop,bc_comm)
        ...
        type(AD_D), allocatable, dimension(:)   ::                                                      &
            ...
            density_1d_out, vel1_1d_out, vel2_1d_out, vel3_1d_out, pressure_1d_out
        ...
        ! 
        ! Compute unresolved perturbation
        !
        ...
        ! 
        ! Done computing unresolved perturbation
        !
...
end module bc_state_turbo_interface_steady_form3
