...
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------------------
    type, public, extends(equation_builder_t) :: filtered_euler
...
contains
    ...
    subroutine init(self)
        class(filtered_euler),   intent(inout)  :: self

        call self%set_name('Filtered Euler')
    ...
    function build(self,blueprint) result(euler_eqns)
        class(filtered_euler),  intent(in)  :: self
        ...
        !
        call euler_eqns%set_name('Filtered Euler')
