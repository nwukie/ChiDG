...
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------------------
    type, public, extends(equation_builder_t) :: filtered_euler_FP1
...
contains
    ...
    subroutine init(self)
        class(filtered_euler_FP1),   intent(inout)  :: self

        call self%set_name('Filtered Euler FP1')
    ...
    function build(self,blueprint) result(euler_eqns)
        class(filtered_euler_FP1),  intent(in)  :: self
        ...
        !
        call euler_eqns%set_name('Filtered Euler FP1')
...
end module eqn_filtered_euler_FP1
