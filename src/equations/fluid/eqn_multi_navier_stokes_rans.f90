module eqn_multi_navier_stokes_rans
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------------------
    type, public, extends(equation_builder_t) :: multi_navier_stokes_rans
    ...
    end type multi_navier_stokes_rans
    !********************************************************************************************
...
contains
    ...
    subroutine init(self)
        class(multi_navier_stokes_rans),   intent(inout)  :: self

        call self%set_name('Multi Navier Stokes RANS')
    ...
    function build(self,blueprint) result(equation_set)
        class(multi_navier_stokes_rans),   intent(in)  :: self
...
end module eqn_multi_navier_stokes_rans
