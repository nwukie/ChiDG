module bc_state_gcl_farfield
    ...
    !!      - farfield interior variables to be used for calculating the boundary flux.
    !!  
    !!  @author Nathan A. Wukie(AFRL)
    !!  @date   8/10/2017
    !!
    !---------------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: gcl_farfield_t
...
contains
    ...
    subroutine init(self)    
        class(gcl_farfield_t),  intent(inout)   :: self

        !
        ! Set name
        !
        call self%set_name('Geometric Conservation Farfield')
    ...
    subroutine compute_bc_state(self,worker,prop,bc_COMM)
        ...
        !
        ! Get u and grad(u) from face interior to farfield
        !
...
end module bc_state_gcl_farfield
