...
contains
    ...
    subroutine compute(self,worker,prop)
        ...
        if (self%apply_boundary_ops) then
            ...
            av1_m  = worker%get_field('Artificial Viscosity - 1'    , 'value', 'face interior')
            av1_p  = worker%get_field('Artificial Viscosity - 1'    , 'value', 'face exterior')

            av2_m  = worker%get_field('Artificial Viscosity - 2'    , 'value', 'face interior')
            av2_p  = worker%get_field('Artificial Viscosity - 2'    , 'value', 'face exterior')

            av3_m  = worker%get_field('Artificial Viscosity - 3'    , 'value', 'face interior')
            av3_p  = worker%get_field('Artificial Viscosity - 3'    , 'value', 'face exterior')
