module fluid_laplacian_av_boundary_average_operator
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------
    type, extends(operator_t), public :: fluid_laplacian_av_boundary_average_operator_t
    ...
    end type fluid_laplacian_av_boundary_average_operator_t
    !********************************************************************************
...
contains
    ...
    subroutine init(self)
        class(fluid_laplacian_av_boundary_average_operator_t),   intent(inout) :: self
        
        !
        ! Set operator name
        !
        call self%set_name('Fluid Laplacian AV Boundary Average Operator')
...
!
        ...
        if (any(ieee_is_nan(av_p(:)%x_ad_))) print *, 'smoothed av_p is nan'
        ...
        flux_1_m = -av_m*grad1_m
        flux_2_m = -av_m*grad2_m
        flux_3_m = -av_m*grad3_m
        ...
        flux_1_p = -av_p*grad1_p
        flux_2_p = -av_p*grad2_p
        flux_3_p = -av_p*grad3_p
        ...
        flux_1_m = -av_m*(grad1_m+pgrad1_m)
        flux_2_m = -av_m*(grad2_m+pgrad2_m)
        flux_3_m = -av_m*(grad3_m+pgrad3_m)
        ...
        flux_1_p = -av_p*(grad1_p+pgrad1_p)
        flux_2_p = -av_p*(grad2_p+pgrad2_p)
        flux_3_p = -av_p*(grad3_p+pgrad3_p)
...
end module fluid_laplacian_av_boundary_average_operator
