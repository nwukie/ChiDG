module fluid_laplacian_av_volume_operator
#include <messenger.h>
    ...
    !!
    !------------------------------------------------------------------------------
    type, extends(operator_t), public :: fluid_laplacian_av_volume_operator_t
    ...
    end type fluid_laplacian_av_volume_operator_t
    !******************************************************************************
...
contains
    ...
    subroutine init(self)
        class(fluid_laplacian_av_volume_operator_t),   intent(inout)      :: self

        ! Set operator name
        call self%set_name('Fluid Laplacian AV Volume Operator')
...
end module fluid_laplacian_av_volume_operator
