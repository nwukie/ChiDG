module model_reynolds_shear_stress
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------------
    type, extends(model_t)  :: reynolds_shear_stress_t
    ...
    end type reynolds_shear_stress_t
    !***************************************************************************************
...
contains
    ...
    subroutine init(self)   
        class(reynolds_shear_stress_t), intent(inout)   :: self

        call self%set_name('Reynolds Shear Stress')
    ...
    subroutine compute(self,worker)
        class(reynolds_shear_stress_t),  intent(in)      :: self
...
end module model_reynolds_shear_stress
