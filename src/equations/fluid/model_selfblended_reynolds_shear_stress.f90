module model_selfblended_reynolds_shear_stress
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------------
    type, extends(model_t)  :: selfblended_reynolds_shear_stress_t
        real(rk)    :: blend = 0.8_rk
    ...
    end type selfblended_reynolds_shear_stress_t
    !***************************************************************************************
...
contains
    ...
    subroutine init(self)   
        class(selfblended_reynolds_shear_stress_t), intent(inout)   :: self
        real(rk)            :: blend 
        integer             :: unit, msg
        logical             :: file_exists
        ...
        call self%set_name('Self Blended Reynolds Shear Stress')
...
end module model_selfblended_reynolds_shear_stress
