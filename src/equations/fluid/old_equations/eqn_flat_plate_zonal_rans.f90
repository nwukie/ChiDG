module eqn_flat_plate_zonal_rans
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------------------
    type, public, extends(equation_builder_t) :: flat_plate_zonal_rans
    ...
    end type flat_plate_zonal_rans
    !********************************************************************************************
...
contains
    ...
    subroutine init(self)
        class(flat_plate_zonal_rans),   intent(inout)  :: self

        call self%set_name('Flat Plate Zonal-RANS')
    ...
    function build(self,blueprint) result(equation_set)
        class(flat_plate_zonal_rans),    intent(in)  :: self
        ...
        !
        call equation_set%set_name('Flat Plate Zonal-RANS')
...
!                call equation_set%add_operator('Fluid Viscous Volume Cylindrical Source')
                ...
                call equation_set%add_model('Constant Viscosity Flat Plate')
...
end module eqn_flat_plate_zonal_rans
