module eqn_joukowski_zonal_rans
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------------------
    type, public, extends(equation_builder_t) :: joukowski_zonal_rans
...
contains
    ...
    subroutine init(self)
        class(joukowski_zonal_rans),   intent(inout)  :: self

        call self%set_name('Joukowski Zonal-RANS')
    ...
    function build(self,blueprint) result(equation_set)
        class(joukowski_zonal_rans),    intent(in)  :: self
        ...
        !
        call equation_set%set_name('Joukowski Zonal-RANS')
...
end module eqn_joukowski_zonal_rans
