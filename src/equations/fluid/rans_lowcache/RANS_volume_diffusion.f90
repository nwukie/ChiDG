...
contains
    ...
    subroutine compute(self,worker,prop)
        ...
        grad1_energy  = worker%get_primary_field_element('Energy'    , 'grad1+lift')
        grad2_energy  = worker%get_primary_field_element('Energy'    , 'grad2+lift')
        grad3_energy  = worker%get_primary_field_element('Energy'    , 'grad3+lift')
        ...
        pressure = worker%get_model_field_element('Pressure', 'value')
