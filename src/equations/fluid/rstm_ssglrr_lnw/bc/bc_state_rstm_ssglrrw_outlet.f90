module bc_state_rstm_ssglrrw_outlet
    ...
    !!
    !--------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: rstm_ssglrrw_outlet_t
    ...
    end type rstm_ssglrrw_outlet_t
    !*******************************************************************************************
...
contains
    ...
    subroutine init(self)
        class(rstm_ssglrrw_outlet_t),   intent(inout) :: self
        
        !
        ! Set operator name
        !
        call self%set_name('RSTMSSGLRRW Outlet')
...
end module bc_state_rstm_ssglrrw_outlet
