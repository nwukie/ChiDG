module bc_state_rstm_ssglrrw_symmetry_x
    ...
    !!
    !--------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: rstm_ssglrrw_symmetry_x_t
    ...
    end type rstm_ssglrrw_symmetry_x_t
    !*******************************************************************************************
...
contains
    ...
    subroutine init(self)
        class(rstm_ssglrrw_symmetry_x_t),   intent(inout) :: self
        
        !
        ! Set operator name
        !
        call self%set_name('RSTMSSGLRRW Symmetry-x')
...
end module bc_state_rstm_ssglrrw_symmetry_x
