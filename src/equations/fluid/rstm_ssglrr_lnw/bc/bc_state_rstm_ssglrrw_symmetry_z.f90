module bc_state_rstm_ssglrrw_symmetry_z
    ...
    !!
    !--------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: rstm_ssglrrw_symmetry_z_t
    ...
    end type rstm_ssglrrw_symmetry_z_t
    !*******************************************************************************************
...
contains
    ...
    subroutine init(self)
        class(rstm_ssglrrw_symmetry_z_t),   intent(inout) :: self
        
        !
        ! Set operator name
        !
        call self%set_name('RSTMSSGLRRW Symmetry-z')
...
end module bc_state_rstm_ssglrrw_symmetry_z
