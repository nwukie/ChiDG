module model_rstm_ssglrrw_blended_coefficients
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------
    type, extends(model_t)  :: rstm_ssglrrw_blended_coefficients_t
    ...
    end type rstm_ssglrrw_blended_coefficients_t
    !***************************************************************************************
...
contains
    ...
    subroutine init(self)   
        class(rstm_ssglrrw_blended_coefficients_t), intent(inout)   :: self

        call self%set_name('RSTMSSGLRRW Blended Coefficients')
    ...
    subroutine compute(self,worker)
        class(rstm_ssglrrw_blended_coefficients_t),     intent(in)      :: self
        ...
        if (any(ieee_is_nan(distance(:)%x_ad_))) print *, 'rstm blended coeff distance is nan'
        if (any(ieee_is_nan(distance(:)%x_ad_))) print *, 'rstm blended coeff interp source ', worker%interpolation_source
...
end module model_rstm_ssglrrw_blended_coefficients
