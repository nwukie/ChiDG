...
!!
!--------------------------------------------------------------------------------
module model_rstm_ssglrrw_turbulence_quantities
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------
    type, extends(model_t)  :: rstm_ssglrrw_turbulence_quantities_t
    ...
    end type rstm_ssglrrw_turbulence_quantities_t
    !***************************************************************************************
...
contains
    ...
    subroutine init(self)   
        class(rstm_ssglrrw_turbulence_quantities_t), intent(inout)   :: self

        call self%set_name('RSTMSSGLRRW Turbulence Quantities')
    ...
    subroutine compute(self,worker)
        class(rstm_ssglrrw_turbulence_quantities_t),     intent(in)      :: self
...
end module model_rstm_ssglrrw_turbulence_quantities
