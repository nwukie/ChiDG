module rstm_ssglrrw_blended_source
    ...
    !!
    !--------------------------------------------------------------------------------
    type, extends(operator_t), public :: rstm_ssglrrw_blended_source_operator_t
    ...
    end type rstm_ssglrrw_blended_source_operator_t
    !******************************************************************************
...
contains
    ...
    subroutine init(self)
        class(rstm_ssglrrw_blended_source_operator_t),   intent(inout)      :: self
        real(rk)            :: blend 
        integer             :: unit, msg
        logical             :: file_exists
        ...
        ! Set operator name.
        call self%set_name('RSTMSSGLRRW Blended Source Operator')
    ...
    subroutine compute(self,worker,prop)
        ...
        type(AD_D), allocatable, dimension(:) ::                            &
            ...
            alpha_w, beta_w, sigma_d_w, omega_blended_source_term,                                     &
        ...
        ! Omega source = production_trace_term - omega_squared_term + omega_blended_source_term
        ...
        omega_blended_source_term   = worker%get_field('Omega Gradient Squared',                     'value', 'element')
        ...
        !                       Omega Source Term
        !========================================================================
        !source = HALF*alpha_w*omega*production_trace/k_t - beta_w*density_omega*omega+sigma_d_w*omega_blended_source_term
        source = HALF*(5.0_rk/9.0_rk)*production_trace/(k_t+1.0e-11) -(3.0_rk/40.0_rk)*density*exp(omega) + (mu_l+0.5_rk*mu_t)*omega_blended_source_term + ssrc_omega
        !source = ZERO
        ...
        !========================================================================
        source = -self%blend*0.5_rk*(production_11 + production_22 + production_33 &
...
end module rstm_ssglrrw_blended_source
