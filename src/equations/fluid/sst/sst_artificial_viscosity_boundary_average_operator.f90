...
contains
    ...
    subroutine compute(self,worker,prop)
        ...
        flux_1_m = -(h_s_m(:,1)**TWO*sst_avc+sigma_k_m*mu_neg_m)*grad1_m
        flux_2_m = -(h_s_m(:,2)**TWO*sst_avc+sigma_k_m*mu_neg_m)*grad2_m
        flux_3_m = -(h_s_m(:,3)**TWO*sst_avc+sigma_k_m*mu_neg_m)*grad3_m
        ...
        flux_1_p = -(h_s_p(:,1)**TWO*sst_avc + sigma_k_p*mu_neg_p)*grad1_p
        flux_2_p = -(h_s_p(:,2)**TWO*sst_avc + sigma_k_p*mu_neg_p)*grad2_p
        flux_3_p = -(h_s_p(:,3)**TWO*sst_avc + sigma_k_p*mu_neg_p)*grad3_p
