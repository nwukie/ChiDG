module type_constant_viscosity_laminar
#include <messenger.h>
    ...
    !!
    !---------------------------------------------------------------------------------------
    type, extends(model_t)  :: constant_viscosity_laminar_t
    ...
    end type constant_viscosity_laminar_t
    !***************************************************************************************
...
contains
    ...
    subroutine init(self)   
        class(constant_viscosity_laminar_t), intent(inout)   :: self

        call self%set_name('Constant Viscosity Laminar')
    ...
    subroutine compute(self,worker)
        class(constant_viscosity_laminar_t),    intent(in)      :: self
...
end module type_constant_viscosity_laminar
