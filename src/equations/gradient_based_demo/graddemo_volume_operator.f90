...
!        energy_residual = -(energy   - ( (98000._rk/(gam-ONE)) + HALF*(mom1_element*mom1_element + mom2_element*mom2_element + mom3_element*mom3_element)/density_element))
!        pressure_residual = -(pressure - 98000._rk)
