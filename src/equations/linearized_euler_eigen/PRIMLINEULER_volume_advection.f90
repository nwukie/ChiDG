module PRIMLINEULER_volume_advection
    ...
    !!
    !----------------------------------------------------------------------------------
    type, extends(operator_t), public :: PRIMLINEULER_volume_advection_t
    ...
    end type PRIMLINEULER_volume_advection_t
    !***********************************************************************************
...
contains
    ...
    subroutine init(self)
        class(PRIMLINEULER_volume_advection_t), intent(inout)   :: self

        ! Set operator name
        call self%set_name("PRIMLINEULER Volume Advection")
    ...
    subroutine compute(self,worker,prop)
        ...
        print*, 'Computing Volume Advection'
        ...
        flux_2 = ZERO
        flux_3 = ZERO
        call worker%integrate_volume_flux('Velocity-1','Advection',flux_1,flux_2,flux_3)
        ...
        flux_2 = ZERO
        flux_3 = ZERO
        call worker%integrate_volume_flux('Velocity-2','Advection',flux_1,flux_2,flux_3)
        ...
        flux_2 = ZERO
        flux_3 = ZERO
        call worker%integrate_volume_flux('Velocity-3','Advection',flux_1,flux_2,flux_3)
        ...
        !
        worker%solverdata%A1 = worker%solverdata%lhs
...
end module PRIMLINEULER_volume_advection
