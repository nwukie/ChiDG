module bc_primlineuler_extrapolate
    ...
    !!
    !-------------------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: primlineuler_extrapolate_t
...
contains
    ...
    subroutine compute_bc_state(self,worker,prop,bc_COMM)
        ...
        call worker%store_bc_state('Velocity-1', u_m,   'value')
        call worker%store_bc_state('Velocity-2', v_m,   'value')
        call worker%store_bc_state('Velocity-3', w_m,   'value')
