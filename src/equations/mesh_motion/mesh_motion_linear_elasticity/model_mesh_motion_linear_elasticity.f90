module model_mesh_motion_linear_elasticity
#include <messenger.h>
...
!    use eqn_wall_distance,  only: get_p_poisson_parameter
    ...
    !!
    !---------------------------------------------------------------------------------------
    type, extends(model_t)  :: mesh_motion_linear_elasticity_m
    ...
    end type mesh_motion_linear_elasticity_m
    !***************************************************************************************
...
contains
    ...
    subroutine init(self)   
        class(mesh_motion_linear_elasticity_m), intent(inout)   :: self

        call self%set_name('Mesh Motion linear_elasticity')
    ...
    subroutine compute(self,worker)
        class(mesh_motion_linear_elasticity_m),     intent(in)      :: self
...
end module model_mesh_motion_linear_elasticity
