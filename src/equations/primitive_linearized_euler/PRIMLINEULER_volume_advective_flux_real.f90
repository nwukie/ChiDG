module PRIMLINEULER_volume_advective_flux_real
    ...
    !!
    !----------------------------------------------------------------------------------
    type, extends(operator_t), public :: PRIMLINEULER_volume_advective_flux_real_t
...
contains
    ...
    subroutine init(self)
        ...
        ! Set operator name
        call self%set_name("PRIMLINEULER Volume Flux Real")
...
!        end do
        ...
        call worker%integrate_volume_flux('Density(real)','Advection',flux_1,flux_2,flux_3)
        ...
        call worker%integrate_volume_flux('Velocity-1(real)','Advection',flux_1,flux_2,flux_3)
        ...
        call worker%integrate_volume_flux('Velocity-2(real)','Advection',flux_1,flux_2,flux_3)
        ...
        call worker%integrate_volume_flux('Velocity-3(real)','Advection',flux_1,flux_2,flux_3)
        ...
        call worker%integrate_volume_flux('Pressure(real)','Advection',flux_1,flux_2,flux_3)
