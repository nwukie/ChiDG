module bc_state_scalar_ale_derivative
    ...
    !!
    !---------------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: scalar_ale_derivative_t
    ...
    end type scalar_ale_derivative_t
    !****************************************************************************************
...
contains
    ...
    subroutine init(self)    
        class(scalar_ale_derivative_t),  intent(inout)   :: self

        !
        ! Set name
        !
        call self%set_name('Scalar ALE Derivative')
...
end module bc_state_scalar_ale_derivative
