module bc_state_scalar_ale_extrapolate
    ...
    !!
    !---------------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: scalar_ale_extrapolate_t
    ...
    end type scalar_ale_extrapolate_t
    !****************************************************************************************
...
contains
    ...
    subroutine init(self)    
        ...
        ! Set name
        !
        call self%set_name('Scalar ALE Extrapolate')
...
end module bc_state_scalar_ale_extrapolate
