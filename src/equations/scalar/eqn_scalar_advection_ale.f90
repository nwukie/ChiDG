module eqn_scalar_advection_ale
#include <messenger.h>
    ...
    !!
    !-----------------------------------------------------------------------------------------------------
    type, extends(equation_builder_t), public :: scalar_advection_ale
...
contains
    ...
    subroutine init(self)
        class(scalar_advection_ale),   intent(inout)  :: self

        call self%set_name('Scalar Advection ALE')
    ...
    function build(self,blueprint) result(scalar_advection_eqn)
        class(scalar_advection_ale),    intent(in)  :: self
        ...
        !
        call scalar_advection_eqn%set_name("Scalar Advection ALE")
        ...
        select case (trim(blueprint))
            ...
            case('default')
                call scalar_advection_eqn%add_operator('Scalar Advection ALE Boundary Average Operator')
                call scalar_advection_eqn%add_operator('Scalar Advection ALE Volume Operator')
                call scalar_advection_eqn%add_operator('Scalar Advection ALE LaxFriedrichs Operator')
                call scalar_advection_eqn%add_operator('Scalar Advection ALE BC Operator')
...
end module eqn_scalar_advection_ale
