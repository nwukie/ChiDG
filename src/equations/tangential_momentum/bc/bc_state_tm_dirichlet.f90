...
#include <messenger.h>
    ...
    !!
    !----------------------------------------------------------------------------------------
    type, public, extends(bc_state_t) :: tm_dirichlet_t
...
contains
    ...
    subroutine init(self)
        class(tm_dirichlet_t),   intent(inout) :: self
        
        !
        ! Set name, family
        !
        call self%set_name("TM Dirichlet")
...
end module bc_state_tm_dirichlet
