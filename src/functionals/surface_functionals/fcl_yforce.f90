...
#include <messenger.h>
    ...
    !>  This functional computes the Y-force generated by a given surface 
    !!
    ...
    !!
    !------------------------------------------------------------------------------------------
    type,  extends(evaluator_t), public   :: yforce_t
...
contains
    ...
    subroutine compute_functional(self,worker,cache)
        ...
        ! Store in cache 
        call cache%set_entity_value(worker%mesh,yforce,'yforce','reference',worker%function_info) 
    ...
    function store_value(self,cache) result(res) 
        ...
        res = cache%ref_cache%get_real('yforce')
    ...
    function store_deriv(self,cache) result(res) 
        ...
        res = cache%ref_cache%get_deriv('yforce')
