...
#include <messenger.h>
    ...
    !!
    !------------------------------------------------------------------------------------------
    type,  extends(evaluator_t), public   :: zforce_t
...
contains
    ...
    subroutine init(self)
        class(zforce_t), intent(inout)   :: self

        call self%set_name("Z-force")
    ...
    subroutine check(self)
        ...
        usr_msg_r = "fcl_zforce: wrong number of reference geometries. The minimum number of reference geometries is 1."
        usr_msg_a = "fcl_zforce: wrong number of auxiliary geometries. The minimum number of auxiliary geometries is 1."
    ...
    subroutine compute_functional(self,worker,cache)
        ...
        zforce_gq = stress_z !* dcos(self%AoA) + stress_y * dsin(self%AoA)
    ...
    function store_value(self,cache) result(res) 
        ...
        res = cache%ref_cache%get_real('zforce')
    ...
    function store_deriv(self,cache) result(res) 
        ...
        res = cache%ref_cache%get_deriv('zforce')

    end function store_deriv
    !*********************************************************************************************


end module fcl_zforce
