module fcl_mass_averaged_flowangle12
#include <messenger.h>
    ...
    !!
    !------------------------------------------------------------------------------------------
    type,  extends(evaluator_t), public   :: mass_averaged_flowangle12_t
    ...
    end type mass_averaged_flowangle12_t
    !******************************************************************************************
...
contains
    ...
    subroutine init(self)
        class(mass_averaged_flowangle12_t), intent(inout)   :: self

        call self%set_name("MA Flow Angle 12")
    ...
    subroutine compute_functional(self,worker,cache)
        ...
        type(AD_D)                            :: u1_flux, u2_flux, mass_flux
...
end module fcl_mass_averaged_flowangle12
