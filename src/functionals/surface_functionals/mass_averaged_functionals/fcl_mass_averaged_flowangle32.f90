module fcl_mass_averaged_flowangle32
#include <messenger.h>
    ...
    !!
    !------------------------------------------------------------------------------------------
    type,  extends(evaluator_t), public   :: mass_averaged_flowangle32_t
    ...
    end type mass_averaged_flowangle32_t
    !******************************************************************************************
...
contains
    ...
    subroutine init(self)
        class(mass_averaged_flowangle32_t), intent(inout)   :: self

        call self%set_name("MA Flow Angle 32")
    ...
    subroutine check(self)
        ...
        usr_msg_r = "fcl_mass_average_flowangle32: wrong number of reference geometries. The minimum number of reference geometries is 1."
        usr_msg_a = "fcl_mass_average_flowangle32: wrong number of auxiliary geometries. The minimum number of auxiliary geometries is 1."
    ...
    subroutine compute_functional(self,worker,cache)
        ...
        type(AD_D)                            :: u3_flux, u2_flux, mass_flux
        ...
        u2_flux = integrate_surface_mass_weighted(worker,u_2)
        ...
        call cache%set_value(u2_flux,  'u2 flux',  'reference',worker%function_info)
    ...
    subroutine finalize_functional(self,cache) 
        ...
        u2_flux   = cache%get_value('u2 flux',  'reference')
...
end module fcl_mass_averaged_flowangle32
