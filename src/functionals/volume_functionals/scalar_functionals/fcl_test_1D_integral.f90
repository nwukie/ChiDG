...
#include <messenger.h>
    ...
    !!
    !------------------------------------------------------------------------------------------
    type,  extends(evaluator_t), public   :: test_1D_integral_t
...
contains
    ...
    subroutine check(self)
        ...
        usr_msg_r = "fcl_test_1D_integral: wrong number of reference geometries. The minimum number of reference geometries required is 1"
        usr_msg_a = "fcl_test_1D_integral: This functional does not require any auxiliary geometry. Please, use `chidg edit` to remove the input auxiliary geometry"
...
end module fcl_test_1D_integral
