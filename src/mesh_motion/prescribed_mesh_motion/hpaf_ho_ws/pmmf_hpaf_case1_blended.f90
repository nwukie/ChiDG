module pmmf_hpaf_case1_blended
#include <messenger.h>
    ...
    !>  hpaf_case1_blended mesh motion. 
    !!
    !!  @author Eric Wolf
    !!  @date   3/15/2017 
    !!
    !!
    !-------------------------------------------------------------------------------
    type, extends(prescribed_mesh_motion_function_t), public :: hpaf_case1_blended_pmmf
        private
    ...
    end type hpaf_case1_blended_pmmf
    !********************************************************************************
...
contains
    ...
    subroutine init(self)
        class(hpaf_case1_blended_pmmf),  intent(inout)  :: self

        !
        ! Set function name
        !
        call self%set_name("hpaf_case1_blended")
...
end module pmmf_hpaf_case1_blended
