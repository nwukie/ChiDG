...
#include <messenger.h>
    ...
    !!
    !-------------------------------------------------------------------------------
    type, extends(prescribed_mesh_motion_function_t), public :: hpaf_case3_pmmf
        private
...
contains
    ...
    subroutine init(self)
        class(hpaf_case3_pmmf),  intent(inout)  :: self

        !
        ! Set function name
        !
        call self%set_name("hpaf_case3")
