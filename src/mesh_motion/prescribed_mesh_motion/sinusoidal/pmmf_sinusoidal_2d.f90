...
#include <messenger.h>
    ...
    !!
    !-------------------------------------------------------------------------------
    type, extends(prescribed_mesh_motion_function_t), public :: sinusoidal_2d_pmmf
        private
...
contains
    ...
    subroutine init(self)
        class(sinusoidal_2d_pmmf),  intent(inout)  :: self

        !
        ! Set function name
        !
        call self%set_name("sinusoidal_2d")
