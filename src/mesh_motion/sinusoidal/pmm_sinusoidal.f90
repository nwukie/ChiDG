...
#include <messenger.h>
    ...
    !!
    !-------------------------------------------------------------------------------
    type, extends(prescribed_mesh_motion_t), public :: sinusoidal_pmm
        private
...
contains
    ...
    subroutine init(self)
        class(sinusoidal_pmm),  intent(inout)  :: self
