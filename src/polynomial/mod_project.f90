...
contains
    ...
    !>  Project discrete values to the polynomial basis
    !!
    !!
    !!  @author Nathan A. Wukie
    !!  @param[in]  dvals   Array of discrete values to be projected. It is assumed that these are located at the
    !!
    !!
    !------------------------------------------------------------------------------
!    subroutine project_discrete_values(dvals,nterms,mcoeff)
!
!
!
!
!    end subroutine
    ...
    !!
    !!  @author Nathan A. Wukie
    !!  @param[in]  fcn     Incoming function to evaluate. Arguments should be in computational coordinates(xi, eta, zeta).
    !!
    !!
    !------------------------------------------------------------------------------
!    subroutine project_function_xez(fcn,nterms,mcoeff)
!        interface
!            function fcn(xi,eta,zeta)
...
!        end interface
!
!!        real(rk), external  :: fcn
!        integer(ik)         :: nterms
!        real(rk)            :: mcoeff(nterms)
!
!
!
!
