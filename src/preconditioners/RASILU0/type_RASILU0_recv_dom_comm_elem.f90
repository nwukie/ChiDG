module type_RASILU0_recv_dom_comm_elem
#include <messenger.h>
    ...
    !!
    !-----------------------------------------------------------------------------------------------
    type, public :: RASILU0_recv_dom_comm_elem_t
    ...
    end type RASILU0_recv_dom_comm_elem_t
    !***********************************************************************************************
...
contains
    ...
    subroutine init(self,nblocks)
        class(RASILU0_recv_dom_comm_elem_t),    intent(inout)   :: self
...
end module type_RASILU0_recv_dom_comm_elem
