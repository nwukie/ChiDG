module type_RASILU0_OVERSET_send
#include <messenger.h>
    use mod_kinds,              only: rk, ik
    use mod_chidg_mpi,          only: IRANK

    use type_RASILU0_OVERSET_send_comm, only: RASILU0_OVERSET_send_comm_t
    ...
    !!
    !------------------------------------------------------------------------------------------
    type, public :: RASILU0_OVERSET_send_t

        type(RASILU0_OVERSET_send_comm_t),  allocatable :: comm(:)  ! One description for each 
    ...
    end type RASILU0_OVERSET_send_t
    !******************************************************************************************
...
contains
    ...
    subroutine init(self,mesh,A)
        class(RASILU0_OVERSET_send_t),  intent(inout)   :: self
...
end module type_RASILU0_OVERSET_send
