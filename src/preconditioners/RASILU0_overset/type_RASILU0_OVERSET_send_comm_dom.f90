module type_RASILU0_OVERSET_send_comm_dom
#include <messenger.h>
    ...
    !!
    !--------------------------------------------------------------------------------------
    type, public :: RASILU0_OVERSET_send_comm_dom_t
    ...
    end type RASILU0_OVERSET_send_comm_dom_t
    !**************************************************************************************
...
end module type_RASILU0_OVERSET_send_comm_dom
