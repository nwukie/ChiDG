...
contains
    ...
    subroutine execute_step3(self)
        ...
        call write_line(step3_4, width=90, color='blue')
    ...
    subroutine execute_step4(self)
        ...
        character(:),   allocatable :: step4_1, step4_2, step4_3
        ...
        step4_2 = "The ChiDG post-processing action(chidg post) expects a grid file and a solution file. In this &
                   case, they are the same."
        step4_3 = "The post-processing step generates data in Tecplot and VTK format. The VTK files can be viewed &
        ...
        call write_line(' ', ltrim=.false.)
        call write_line(step4_3, width=90, color='blue')
    ...
    subroutine execute_step5(self)
        ...
        character(:),   allocatable :: step5_1, step5_2

        step5_1 = "Other resources."
        step5_2 = "International Workshop on High-Order CFD Methods: https://how4.cenaero.be/content/bi2-inviscid-flow-over-bump"


        call write_line(step5_1, width=90, color='blue')
        call write_line(' ', ltrim=.false.)
    ...
    subroutine execute_step6(self)
        ...
        character(:),   allocatable :: step6_1

!        step6 = "The End."
!
!
!        call write_line(step6_1, width=90, color='blue')
