program cylinder_chimera
    ...
    real(rk)    :: xcenter, ycenter, zcenter, cradius, &
                   ...
                   thetamin, thetamax, theta, clustering_factor, thetaoverlap
    ...
    !
    write(buffer,'( "cylinder_chimera_overlapping_multipledonor.x" )')
    ...
    !
    !thetaoverlap = 5._rk * PI / 180._rk
    thetaoverlap = 8._rk * PI / 180._rk
    thetamin = (((3._rk*PI/2._rk) + PI ) / 2._rk) - thetaoverlap
    thetamax = ((3._rk*PI/2._rk) + 2*PI ) / 2._rk + thetaoverlap
